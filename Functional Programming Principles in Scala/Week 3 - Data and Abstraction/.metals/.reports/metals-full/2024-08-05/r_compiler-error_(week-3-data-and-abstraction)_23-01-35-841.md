file://<HOME>/git/scala-course/Functional%20Programming%20Principles%20in%20Scala/Week%203%20-%20Data%20and%20Abstraction/src/main/scala/objsets/TweetSet.scala
### java.lang.AssertionError: assertion failed: position error, parent span does not contain child span
parent      = new java.util.NoSuchElementException(null) # -1,
parent span = <5471..5509>,
child       = null # -1,
child span  = [5508..5512..5512]
...
Scala version: 3.3.0
Classpath:
<WORKSPACE>/.bloop/week-3-data-and-abstraction/bloop-bsp-clients-classes/classes-Metals-0xiunebVRzmxA8jWYsLBiw== [exists ], <HOME>/.cache/bloop/semanticdb/com.sourcegraph.semanticdb-javac.0.10.0/semanticdb-javac-0.10.0.jar [exists ], <HOME>/.cache/coursier/v1/https/repo1.maven.org/maven2/org/scala-lang/scala3-library_3/3.3.0/scala3-library_3-3.3.0.jar [exists ], <HOME>/.cache/coursier/v1/https/repo1.maven.org/maven2/org/scala-lang/scala-library/2.13.10/scala-library-2.13.10.jar [exists ]
Options:
-language:implicitConversions -deprecation -Xsemanticdb -sourceroot <WORKSPACE> -release 11


action parameters:
uri: file://<HOME>/git/scala-course/Functional%20Programming%20Principles%20in%20Scala/Week%203%20-%20Data%20and%20Abstraction/src/main/scala/objsets/TweetSet.scala
text:
```scala
package objsets
...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet:
  ...
  override def filterAcc(p: Tweet => Boolean, acc: TweetSet): TweetSet = 
    ...
    val filterRight = left.filterAcc(p, filterLeft)
